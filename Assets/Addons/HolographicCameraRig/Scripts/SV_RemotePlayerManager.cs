...
namespace SpectatorView
{
    ...
    public class SV_RemotePlayerManager : SpectatorView.SV_Singleton<SV_RemotePlayerManager>
    {
        ...
        private void SessionUsersTracker_UserLeft(User user)
        {
            ...
            {
                HoloDebug.Log("UserLeft:" + i + ":" + HoloToolkit.Sharing.SharingStage.Instance.SessionUsersTracker.CurrentUsers[i].GetID());
        ...
        {
            HoloDebug.Log(user.GetID().ToString());

            for (int i = 0; i < HoloToolkit.Sharing.SharingStage.Instance.SessionUsersTracker.CurrentUsers.Count; ++i)
            {
                HoloDebug.Log("UserJoined:" + i+":"+HoloToolkit.Sharing.SharingStage.Instance.SessionUsersTracker.CurrentUsers[i].GetID());
        ...
        void UpdateHeadTransform(NetworkInMessage msg)
        {
          ...
          //  Debug.Log(headInfo.IP +":"+ headPos.ToString());

...
namespace SpectatorView
{
    ...
    /// </summary>
    public class SV_ImportExportAnchorManager : Singleton<SV_ImportExportAnchorManager>
    {
        /// <summary>
        ...
        void InitRoomApi()
        {
            ...
            {
                if (HolographicCameraManager.Instance.editorUser == null)
                {
                    HoloDebug.Log("not editor!");
                }
                else {

                    HoloDebug.Log("editor editor!");
                }

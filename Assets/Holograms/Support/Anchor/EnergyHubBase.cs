...
public class EnergyHubBase : SpectatorView.SV_Singleton<EnergyHubBase>
{
    ...
    void OnSelect()
    {
        ...
        PeopleManager pm = this.gameObject.GetComponentInChildren<PeopleManager>();//.GetComponent<Renderer>()
        TaskManager.Run(pm.grow());
        this.transform.Find("BlobOutside").gameObject.SetActive(false);
        this.transform.Find("BlobOutside/BlobInside").gameObject.SetActive(false);
